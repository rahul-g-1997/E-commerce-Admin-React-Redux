...
export const add_to_database = (newData) => ({
  newData,
  type: ADD_TO_DATABASE,
});
export const delete_from_database = (newData) => ({
  newData,
  type: DELETE_FROM_DATABASE,
});
export const unsorted_data = (newData) => ({ newData, type: UNSORTED_DATA });
export const add_to_unsorted_data = (newData) => ({
  newData,
  type: ADD_TO_UNSORTED_DATA,
});
export const item_details_data = (newData) => ({
  newData,
